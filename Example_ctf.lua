...
--Capture the Flag for stand-alone multiplayer
    ...
    herosupport:SetHeroClass(ALL, "all_hero_luke_jedi")
    herosupport:SetHeroClass(IMP, "imp_hero_emperor")
    herosupport:AddSpawnCP("cp3CTF","Team1Off01SpawnPath")
    herosupport:AddSpawnCP("cp4CTF","Team2Off01SpawnPath")
    herosupport:Start()          
