...
function ScriptPostLoad()
	...
	SetProperty("CP1CON", "CaptureRegion", "NoRegionForYou")
	SetProperty("CP3CON", "CaptureRegion", "NoRegionForYou")
	SetProperty("CP4CON", "CaptureRegion", "NoRegionForYou")
	SetProperty("CP5CON", "CaptureRegion", "NoRegionForYou")
...
--                             "cis_walk_spider",
    ...
    --Extra units added to REP side
    AddUnitClass(REP,"cis_inf_rifleman",  2,5)
    AddUnitClass(REP,"cis_inf_rocketeer",  2,5)
...
--    AddCameraShot(0.940831, -0.108255, -0.319013, -0.036707, -65.793930, 66.455177, 289.432678);
    ...
    herosupport = AIHeroSupport:New{AIATTHeroHealth = 2500, AIDEFHeroHealth = 3000, gameMode = "conquest", minSpawnTime = 35,}
